...
RUN \
  ...
  apt-get update && \
  apt-get -y --no-install-recommends install apt-utils bash python3 python3-pip wget zip gcc autoconf automake libtool pkg-config make cmake usbutils unzip python-setuptools && \
